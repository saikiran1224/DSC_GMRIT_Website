...
<!--                     <p class="p-heading p-large">We serve small and medium sized companies in all tech related industries with high quality growth services which are presented below</p> -->
    ...
    <?php 
                           ...
                           $a=1; 
                           $stmt = $conn->prepare( 
                                "SELECT * FROM event_details where event_status='Upcoming'"); 
                           $stmt->execute(); 
                           $users = $stmt->fetchAll(); 
...
<?php foreach($users as $user)  
  ...
  <?php  
                                          ...
                                          <tr>  
                                               <td>  
                                                    <img class='card-img-top' src='./admin/uploads/".$user['event_logo']."' height='200' width='200' class='img-thumnail' />  
                                               </td>  
                                          </tr>  
                                     ";   ?> 
                                                                
  <div class="card-body">
    <h5 class="card-title"><?php  echo $user['event_name']; ?></h5>
    <p class="card-text">Date: <?php  echo $user['date']; ?></p>
                        ...
                        {   ?>
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text"><?php echo $user['question']; ?> </p>
