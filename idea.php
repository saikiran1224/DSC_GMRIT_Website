...
$stmt = $conn->prepare("insert into idea_spot(idea_id,name,email_id,idea_description,idea_summarization,idea_uniqueness,idea_title)values('$idea_id','$name','$idea_gmail','$idea_description','$idea_summarization','$idea_uniqueness','$idea_title')");
$stmt->execute();
